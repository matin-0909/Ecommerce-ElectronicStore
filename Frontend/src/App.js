...
import ViewOrderDetail from "./pages/viewOrderDetails.jsx"
import  ViewOrderHistory from "./pages/viewOrderHistory.jsx"
      ...
      <div>
        <Routes>
          ...
          <Route path='/category/:categoryName' element={<CategoryPage/>}></Route>
           ...
           <Route path='/viewOrderDetails' element={<ViewOrderDetail/>}></Route>
           <Route path='/viewOrderHistory' element={<ViewOrderHistory/>}></Route>
           <Route path='/aboutus' element={<AboutUsPage/>}></Route>
           <Route path='/search' element={<Search/>}></Route>
           <Route path='/addcarddeatils' element={<ATM/>}></Route>
